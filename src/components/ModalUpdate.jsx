...
export const ModalUpdate = ({ product, handleClose }) => {
  ...
  const submitData = async () => {
    ...
    try {
      await axios.put(`http://localhost:3002/api/v1/products/${product?._id}`, data)
  ...
  return (
    <Box sx={style}>
      ...
      <div style={{ marginTop: 20 }}>
        ...
        <Button onClick={submitData} style={{ marginTop: 10 }} variant="contained" color="success">Editar</Button>
      </div>
    </Box>
  )
}
